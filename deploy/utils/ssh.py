...
PRIV_SSH_DIR = os.path.join(PROJECT_ROOT_PATH, ".ssh")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Uses the ssh-keygen and ssh-copy-id commands found on Mac and Linux systems. "
                    "Mac Users will need to install ssh-copy-id before attempting to use this script. "
                    "If you do not have Homebrew installed, "
                    "please visit https://github.com/beautifulcode/ssh-copy-id-for-OSX for the install. "
                    "If you do have Homebrew installed, run the command brew install ssh-copy-id in Terminal.")
